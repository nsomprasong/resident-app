        ...
        <form action={formAction} className="space-y-5">
          ...
          <div>
            ...
            <p className="mt-1.5 text-xs text-muted-foreground">
              ใช้ Username หรือเบอร์โทร (หรืออีเมลติดต่อถ้ามีในระบบ) พร้อมรหัสผ่าน
              — บัญชีที่แอดมินสร้างใหม่ / รีเซ็ตรหัสผ่าน: ใส่ Username หรือเบอร์แล้วกดเข้าสู่ระบบโดยไม่ต้องใส่รหัสผ่านเพื่อไปตั้งรหัสผ่านเอง
            </p>
          </div>
          {state.error ? (
            <p
